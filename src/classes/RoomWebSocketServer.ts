import type { MessageBase, MessageMap, RoomFactory, RWSConfig, SystemOutboundMessage } from "../types/WSTypes";
...
> extends WebSocketServer<UserMessage, OutMessage> {
    ...
    public getRoom = (id: string): Optional<Room> =>
        this.rooms.getOptional(id);

    public getRooms = (): Room[] =>
        this.rooms.toArray().map(e => e.value);
