import type { MessageBase, MessageMap, MessageValidator, SystemInboundMessage, SystemOutboundMessage, WSConfig } from "../types/WSTypes";
...
> extends EventEmitter {
    ...
    private handleMessage(data: Data, client: Client) {
        ...
        catch { return this.sendError(client, "Invalid JSON format"); }
